...
# Load the dataset
data_path = '/Users/ahmed/Desktop/Machine Learning/sentiment.csv'
data = pd.read_csv(data_path)

# Define the target column as the first column and the text column as the second column
TARGET_COLUMN = data.columns[0]
TEXT_COLUMN = data.columns[1]

# Perform sentiment analysis on the second column
data['sentiment'] = data[TEXT_COLUMN].apply(lambda text: TextBlob(str(text)).sentiment.polarity)
