...
# Load a subset of the dataset to handle large file size efficiently
data_path = '/Users/ahmed/Desktop/Machine Learning/MultiClass_1m.csv'
chunk_size = 100000  # Load the dataset in chunks
data_iterator = pd.read_csv(data_path, chunksize=chunk_size)

# Process the first chunk to get a sample of the dataset
data = next(data_iterator)

# Define the target column as the last column
TARGET_COLUMN = data.columns[-1]

# Data Preprocessing Function
def preprocess_data(data, target_column):
    """
    Preprocess the dataset: scales numerical features and handles missing values.
    """
